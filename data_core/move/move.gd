...
enum MoveId {
	...
	# Z Moves (Auto-incrementing from 848)
...
# Constantes utilitarias con tipado estricto
const MOVE_DEFAULT: int = 0x3FFF
const MOVE_UNAVAILABLE: int = 0xFFFF
const MOVE_RANDOM_TEACHABLE: int = MoveId.MOVE_G_MAX_RAPID_FLOW + 1
