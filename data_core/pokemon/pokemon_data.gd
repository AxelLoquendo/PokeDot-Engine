...
const EGG_GROUPS_PER_MON: int = 2
#Naturalezas Pokemon
enum Nature {
...
const NATURE_RANDOM: int = NUM_NATURES
const NATURE_MAY_SYNCHRONIZE: int = NUM_NATURES + 1
...
static var CONDITIONS_END: int = EvolutionConditions.size()
# metodos evolutivos
