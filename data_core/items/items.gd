...
enum EffectItem {
	EFFECT_ITEM_ENIGMA_BERRY_EREADER = 1,
...
const ITEM_LIST_END: int = 0xFFFF

# Asumiendo Gen 8+ para las bayas de confusión (B_CONFUSE_BERRIES_HEAL >= GEN_8)
const CONFUSE_BERRY_HEAL_FRACTION: int = 3
const CONFUSE_BERRY_HP_FRACTION: int = 4

const MAX_BAG_ITEM_CAPACITY: int = 999
const MAX_PC_ITEM_CAPACITY: int = 999
const MAX_PYRAMID_BAG_ITEM_CAPACITY: int = 99

const MAX_ITEM_DIGITS: int = 3
const MAX_PYRAMID_ITEM_DIGITS: int = 3

const MAIL_NONE: int = 0xFF

# Secondary IDs for rods
const OLD_ROD: int = 0
const GOOD_ROD: int = 1
const SUPER_ROD: int = 2

# Secondary IDs for bikes
const MACH_BIKE: int = 0
const ACRO_BIKE: int = 1
const STANDARD_BIKE: int = 2

# Item parameters for EXP Candies
const EXP_100: int = 1
const EXP_800: int = 2
const EXP_3000: int = 3
const EXP_10000: int = 4
const EXP_30000: int = 5

# Funciones de utilidad (reemplazan a las macros de C)
static func item_to_mail(item_id: int) -> int:
	return item_id - ItemId.ITEM_ORANGE_MAIL

static func item_to_mulch(item_id: int) -> int:
	return (item_id - ItemId.ITEM_GROWTH_MULCH) + 1
