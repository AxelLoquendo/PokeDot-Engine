...
# Terrain seed params
const HOLD_EFFECT_PARAM_ELECTRIC_TERRAIN: int = 0
const HOLD_EFFECT_PARAM_GRASSY_TERRAIN: int = 1
const HOLD_EFFECT_PARAM_MISTY_TERRAIN: int = 2
const HOLD_EFFECT_PARAM_PSYCHIC_TERRAIN: int = 3
